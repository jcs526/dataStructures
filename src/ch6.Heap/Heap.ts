...
class Heap<T> implements IHeap<T> {
    ...
    private compare: Comparator<T>; // 비교 함수
...
const minHeapComparator: Comparator<number> = (a, b) => a - b;
const maxHeapComparator: Comparator<number> = (a, b) => b - a;

// 최소 힙 및 최대 힙 사용 예시
const minHeap = new Heap<number>(minHeapComparator);
const maxHeap = new Heap<number>(maxHeapComparator);
